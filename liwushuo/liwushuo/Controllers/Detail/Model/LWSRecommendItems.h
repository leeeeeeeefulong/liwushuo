...
@interface LWSRecommendItems : NSObject <NSCoding, NSCopying>

@property (nonatomic, strong) NSString *recommendItemsDescription;
...
@property (nonatomic, assign) double recommendItemsIdentifier;
